...
///enums
///response
const getObligationListResponse_1 = require("../responses/getObligationListResponse");
///response
let ObligationContract = class ObligationContract extends fabric_contract_api_1.Contract {
    ...
    async createObligation(ctx, _obligationStr, type) {
        ...
        try {
            ...
            _history.Detailing = descriptionForHistory_1.DescriptionForHistory.CREATE_OBLIGATION.replace("debitorOrCreditor", type == "creditor" ? "кредитора" : "заемщика");
    ...
    async addObligationStatus(ctx, _addObligationStatusRequestStr) {
        ...
        try {
            ...
            if (trade.lifeStage != tradeLifeStage_1.TradeLifeStage.ACCEPT_CONTRACT_CREDITOR && trade.lifeStage != tradeLifeStage_1.TradeLifeStage.ADD_PRICE_TO_CONTRACT
            ...
            if (!obligation.is_revaluation) {
                ...
                if (isNeedChangeLifeStage) {
                    if (trade.lifeStage == tradeLifeStage_1.TradeLifeStage.ACCEPT_CONTRACT_CREDITOR) {
            ...
            var _history = new historyModel_1.History();
            _history.Detailing = descriptionForHistory_1.DescriptionForHistory.ADD_OBLIGATION_STATUS;
    ...
    async getObligationList(ctx, contrID) {
        var result = new dataResult_1.DataResult();
        try {
            ...
            obligation.forEach(element => {
                let newobligation = new getObligationListResponse_1.GetObligationListResponse();
